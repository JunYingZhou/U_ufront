...
import { userLogin1, accountLogin,weiXinLogin } from '@/api/user'
...
const getOpenId = (code: any) => {
  ...
  uni.request({
				    ...
				    method:'GET',
				    data: {
						appid: 'wxbd07dfc22497c8a8',        //你的小程序的APPID
						secret: '0a0c609018dcbb1e8877800fc542b7f6',    //你的小程序秘钥secret,  
...
<template>
  <view class="container">
    ...
    <view class="weixin-login-btn">
      <image class="weixin-logo" src="@/static/images/weiXinLogo.png" />
